# This is a sample file to remind how to use the crystal_lib binding generation
# project: https://github.com/crystal-lang/crystal_lib
...
# @[Include("path/to/openssl-1.1.0j/include/openssl/ec.h")]
# @[Include("path/to/openssl-1.1.0j/include/openssl/objects.h")]
# @[Include("path/to/openssl-1.1.0j/include/openssl/evp.h")]
# @[Include("path/to/openssl-1.1.0j/include/openssl/bn.h")]
# @[Link("ssl")]
# lib LibSSL
